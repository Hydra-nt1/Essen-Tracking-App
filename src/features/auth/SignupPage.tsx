  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-sm">
        <h1 className="mb-6 text-2xl font-semibold text-gray-900">Registrieren</h1>
        {success ? (
          <p className="text-sm text-gray-700">
            Konto erstellt. Falls die Bestätigungs-E-Mail-Funktion aktiv ist, prüfe dein Postfach. Danach kannst du
            dich <Link to="/login" className="font-medium text-green-600 hover:underline">anmelden</Link>.
          </p>
        ) : (
          <>
